...
function Payment() {
  ...
  // Íconos SVG simples por marca
  const BrandIcon = ({ brand, active }) => {
    const opacity = active ? 1 : 0.3;

    if (brand === "Visa") return (
      <svg width="38" height="24" viewBox="0 0 38 24" style={{ opacity }} xmlns="http://www.w3.org/2000/svg">
    ...
    if (brand === "Amex") return (
      <svg width="38" height="24" viewBox="0 0 38 24" style={{ opacity }} xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="4" y="17" fill="white" fontSize="9" fontWeight="bold" fontFamily="Arial">AMEX</text>
      </svg>
    );
            ...
            <div className="pay-right">
              ...
              <div className="pay-method-card">
                ...
                <div className="pay-method-header">
                  <h3 className="pay-method-title">Paga ahora</h3>
              {/* Opciones de pago */}
              <div className="pay-method-card">
                ...
                {paymentMethods.map((method, index) => {
                  ...
                  return (
                    <div
                      key={method.id}
                      className={`payment-method-wrapper ${isActive ? "expanded" : ""}`}
                    >
                      {/* Botón opción */}
                      <button
                        type="button"
                        className={`payment-option ${isActive ? "active" : ""}`}
                        onClick={() => setSelectedMethod(isActive ? "" : method.id)}
                      >
                        <div className="payment-option-top">

                          <div className="payment-option-left">
                            <div className={`payment-radio ${isActive ? "checked" : ""}`}>
                              <div className="payment-radio-inner"></div>
                            </div>
                            <div>
                              <p className="payment-option-name">{method.name}</p>
                              {/* Íconos de marca con opacidad según número ingresado */}
                              <div className="payment-logos">
                                {method.logos.map((logo) => (
                                  <BrandIcon
                                    key={logo}
                                    brand={logo}
                                    active={!brand || brand === logo}
                                  />
                                ))}
                              </div>
                            </div>
                          ...
                          <div className="pay-form">
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const value = e.target.value
                                      ...
                                      .replace(/(.{4})/g, "$1 ")
                                      .trim();
                                    updateCard(method.id, "number", value);
                                  }}
                                />
                                {/* Ícono de marca dentro del input */}
                                {brand && (
                                  <span className="pay-input-brand-icon">
                                    <BrandIcon brand={brand} active={true} />
                                  </span>
                                )}
                              </div>
                            </div>
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    updateCard(method.id, "expiry", value);
                                  }}
                                />
                              </div>
                              <div>
                                ...
                                <input
                                  ...
                                  maxLength={4}
                                  onChange={(e) =>
                                    updateCard(method.id, "cvv", e.target.value.replace(/\D/g, ""))
                                  }
                                />
                              </div>
                            </div>
                            ...
                            <div>
                              ...
                              <input
                                ...
                                value={card.name}
                                onChange={(e) => updateCard(method.id, "name", e.target.value)}
                              />
                            </div>
